...
function Home() {
  return (
    <div className="pageBackground">
      ...
      <p>Together we have chased our dream of moving to Cornwall and buying the most amazing little farmhouse in the iddle of nowhere but central to everywhere... in Cornwall that is 😊</p>
      ...
      <p>Join us as we share with you our journey, everything from growing our own, to boating, to career changes, to wellness and beyond</p>
